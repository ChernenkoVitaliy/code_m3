package com.company.examples.m1.sample5_jaxb;
...
public class MainM1S5 {
    public static void main(String[] args) {
        ...
        catalog.add(new Book("Author1", "Title1", 14.5, new Date()));
        catalog.add(new Book("Author2", "Title2", 66, new Date()));


        try {
            File file = new File("D:\\my_files\\java\\java pro\\filesForTest\\jaxbxml.xml");
